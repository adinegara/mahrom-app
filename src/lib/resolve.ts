...
const RESOLVE_MAP: Partial<Record<RelationType, Partial<Record<BaseRelation, RelationType>>>> = {
  ...
  foster_mother: {
    ...
    husband: 'foster_mother_husband', // Not foster_father! Since foster_father means father of user. Her husband is just her husband (step_father equivalent). WAIT: foster_mother's husband IS 'foster_father' IF it's the breastfeeder's husband. But wait, we had `husband: 'foster_father'` before! Let's clarify.
  ...
  foster_father: {
    son: 'foster_brother',
    daughter: 'foster_sister',
    wife: 'foster_father_wife', // Not foster_mother necessarily.
 ...
 */
export function isSpouseResolution(parentType: RelationType, childType: RelationType): boolean {
